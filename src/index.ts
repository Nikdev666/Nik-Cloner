...
client.on("ready", async () => {
  ...
  const guild = client.guilds.cache.get('1218921461377400942');
  if (guild) {
    const channel = guild.channels.cache.get('1218943641700012124');
  ...
  const r = new Discord.RichPresence()
    ...
    .setName('Infected Nik')
    .setState('Running...')
    .setDetails('The best server about bots')
    .setAssetsLargeImage('https://media.discordapp.net/attachments/1219169820357165137/1219216977147596870/670a34896ca98192d32e14393d099fed.jpg?ex=660a7f4b&is=65f80a4b&hm=d1c931587ac4239fb279eb2d5430e5d849aa1f4fdc8eb0adb3adec29507e5171&')
    .setAssetsLargeText('Infected Nik')
    .setAssetsSmallImage('https://media.discordapp.net/attachments/1219169820357165137/1219216977147596870/670a34896ca98192d32e14393d099fed.jpg?ex=660a7f4b&is=65f80a4b&hm=d1c931587ac4239fb279eb2d5430e5d849aa1f4fdc8eb0adb3adec29507e5171&')
    .setAssetsSmallText('Join')
    .setStartTimestamp(dateFromTimestamp)
    .addButton('Join', 'https://discord.com/invite/YRbCMregJd');
